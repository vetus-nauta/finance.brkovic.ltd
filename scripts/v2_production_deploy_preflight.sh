...
assert_grep 'RedirectMatch[[:space:]]+403[[:space:]]+\^/\(app\|storage\|deploy\|cron\|backups\|zip-archives\|test-results\|node_modules\)\(/\|\$\)' '.htaccess' 'root .htaccess blocks private/runtime directories'
