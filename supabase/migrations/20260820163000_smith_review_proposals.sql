...
-- The user gets a review step before money is written to the operational
-- journal. Proposals keep source lineage for notes, scanner, Telegram, voice,
-- and future multilingual Smith decisions.
